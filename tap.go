...
type FeedFilterType string // Type of key filtered from the feed (User doc, etc.)
...
type FeedArguments struct {
	...
	FilterFunc       func(eventID []byte) (bool, FeedFilterType) // Function to filter keys and return type from feed
}
